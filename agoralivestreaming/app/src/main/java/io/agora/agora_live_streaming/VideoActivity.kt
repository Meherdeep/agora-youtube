...
class VideoActivity : AppCompatActivity(){
    ...
    fun initAgoraEngineAndJoinChannel() {
        ...
        // Sets the Channel Profile to Live Broadcasting and User role as selected by the user in MainActivity
        ...
        // Joins the channel provided by user in the MainActivity
        joinChannel()
    }
    ...
    private val mRtcEventHandler: IRtcEngineEventHandler = object : IRtcEngineEventHandler() {
        ...
        override fun onJoinChannelSuccess(channel: String?, uid: Int, elapsed: Int) {
            runOnUiThread { println("User joined success : $uid") }
        }
    ...
    private fun initializeAgoraEngine() {
        try {
            ...
            println("mRtcEngine initialized")
        } catch (e: Exception) {
            println("Exception while initializing RtcEngine: $e")
        }
    }
